...
#
P_DYNAMIC_ISLAND_APPSWITCH_MAX_EXPAND_WIDTH=170 # Max size per character of app name
...
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=170 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=75
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_MAX_EXPAND_WIDTH=170 # Max size when expanded
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=75
...
P_DYNAMIC_ISLAND_WIFI_EXPAND_HEIGHT=100
